...
class MicropostsInterfaceTest < MicropostsInterface
  ...
  test "shoud paginate microposts" do
    get root_path
    assert_select 'div.pagination'
  end

  test "should show erros but not create micropost on invalid submission" do
